This project uses the Android Studio wizard and Blank Activity to create a project. It integrates two separate paths for Robolectric integration in two separate branches.
